  ...
  return (
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <div className='flex justify-end items-center mb-8'>
            <button onClick={prevPorjet} className='p-3 bg-gray-200 rounded mr-2' aria-label='Previous Project'>
                <img src={assets.left_arrow} alt="Previous" />
            </button>
            <button onClick={nextPorjet} className='p-3 bg-gray-200 rounded mr-2' aria-label='Next Project'>
                    ...
                    <div key={index} className='relative shrink-0 w-full sm:w-1/4'>
                        ...
                        <div className='absolute bottom-5 left-0 right-0 flex justify-center'>
                            <div className='inline-block bg-white w-3/4 px-4 py-2 shadow-md'>
                                ...
                                <p className='text-gray-500 text-sm'>{project.price} <span className='p-1'></span> {project.location}</p>
                            </div>
